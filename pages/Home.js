    ...
    <div className="min-h-screen font-sans text-white bg-[#0b0f14]">
      ...
      <header className="py-24">
        <div className="max-w-4xl mx-auto text-center px-6">
          ...
          <div className="mt-8 flex items-center justify-center gap-4">
            <button className="bg-yellow-400 text-black font-bold py-3 px-6 rounded shadow">Get Started</button>
            <button className="bg-transparent border border-gray-700 text-slate-300 py-3 px-5 rounded">Try Demo</button>
          </div>
        </div>
      </header>
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <article className="rounded-xl border border-gray-800 bg-[rgba(255,255,255,0.01)] p-8 shadow-lg">
              ...
              <button className="w-full py-3 rounded border border-gray-700 text-slate-200">Start Watching</button>
            </article>
            ...
            <article className="rounded-xl border border-gray-800 bg-[rgba(255,255,255,0.01)] p-8 shadow-lg">
              ...
              <button className="w-full py-3 rounded border border-gray-700 text-slate-200">View Dictionary</button>
            </article>
            ...
            <article className="rounded-xl border border-gray-800 bg-[rgba(255,255,255,0.01)] p-8 shadow-lg">
              ...
              <button className="w-full py-3 rounded border border-gray-700 text-slate-200">Start Practice</button>
            </article>
          </div>
        </div>
      </section>
      ...
      <section className="pb-32">
        <div className="max-w-2xl mx-auto text-center px-6">
          ...
          <button className="bg-yellow-400 text-black font-bold py-3 px-6 rounded">Sign Up Now</button>
        </div>
      </section>
    </div>
  );
